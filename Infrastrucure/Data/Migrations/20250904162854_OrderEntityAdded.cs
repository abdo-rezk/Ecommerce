        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ItemOredered_ProductItemId = table.Column<int>(type: "INTEGER", nullable: false),
                    ItemOredered_ProductName = table.Column<string>(type: "TEXT", nullable: false),
                    ItemOredered_ProductUrl = table.Column<string>(type: "TEXT", nullable: false),
                    Price = table.Column<double>(type: "decimal(18,2)", nullable: false),
